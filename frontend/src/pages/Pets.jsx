        ...
        <div className="space-y-4">
          {pets.map((pet) => (
            <div key={pet.id} className="card">
              ...
              {pet.notes && <p className="mt-4 text-sm text-slate-600">{pet.notes}</p>}
            </div>
          ))}
          {pets.length === 0 && <p className="text-sm text-slate-500">Aún no hay mascotas registradas.</p>}
        </div>

        <div className="card">
          <h2 className="font-display text-xl font-semibold">Agregar mascota</h2>
          <form className="mt-4 space-y-3" onSubmit={handleSubmit}>
            ...
            <div>
              ...
              <select className="input" name="species" value={form.species} onChange={handleChange}>
            ...
            <div>
              ...
              <input className="input" name="breed" value={form.breed} onChange={handleChange} />
            </div>
            <div>
              <label className="label">Sexo</label>
              <select className="input" name="sex" value={form.sex} onChange={handleChange}>
            ...
            <div>
              ...
              <input className="input" type="number" step="0.01" name="weight_kg" value={form.weight_kg} onChange={handleChange} />
            </div>
            <div>
              <label className="label">Microchip</label>
              <input className="input" name="microchip_id" value={form.microchip_id} onChange={handleChange} />
            </div>
            <div>
